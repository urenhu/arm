...
#line 5 "..\\usr_lib\\usr_ad9850.c"
#line 6 "..\\usr_lib\\usr_ad9850.c"
...
static void pulse(const u8 pin) 
{
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), pin );
	delay_us(10);
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), pin );
	delay_us(10);
}
...
void usr_ad9850_set (const u32 frequency)
{
	...
	freq = (float)4294967295 / 125000000;
	freq *= frequency;
	word = (u32)freq;
