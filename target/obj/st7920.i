...
#line 12 "..\\glcd\\st7920.c"
#line 1 "..\\glcd\\st7920.h"
...
#line 14 "..\\glcd\\st7920.h"
#line 15 "..\\glcd\\st7920.h"


#line 23 "..\\glcd\\st7920.h"
 

#line 32 "..\\glcd\\st7920.h"
...
{   
    ...
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), &GPIO_InitStructure);
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x0800));

    usrspi2_init(1, 0, 0); 
    usrspi2_setspeed(((uint16_t)0x0038));  
                                                  
    *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(11<<2)))) = 0;    
    delay_ms(100);   
    *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(11<<2)))) = 1; 
    delay_ms(1);   
...
{   
    ...
    for (j=0;j<32;j++) {
        for (i=0;i<8;i++) {
            LCD_Write(1,0x80+j);      
            LCD_Write(1,0x80+i);      
            LCD_Write(0,img[j*16+i*2]);  
            LCD_Write(0,img[j*16+i*2+1]);    
        }   
    }   
    for (j=32;j<64;j++) {
        for (i=0;i<8;i++) {
            LCD_Write(1,0x80+j-32);   
            LCD_Write(1,0x88+i);   
            LCD_Write(0,img[j*16+i*2]);   
            LCD_Write(0,img[j*16+i*2+1]);   
        }   
