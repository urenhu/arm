...
#line 16 "..\\glcd\\st7066\\st7066.c"
#line 1 "..\\glcd\\st7066\\st7066.h"




#line 6 "..\\glcd\\st7066\\st7066.h"

#line 15 "..\\glcd\\st7066\\st7066.h"
...
static lcd_dev   oDev[] = {
  ...
  { 2 , ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),  ((uint16_t)0x1000), ((uint32_t)0x00000004), Bit_RESET},
  { 3  , ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),  ((uint16_t)0x8000), ((uint32_t)0x00000004), Bit_RESET},
  { 4 , ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),  ((uint16_t)0x0010) , ((uint32_t)0x00000040), Bit_RESET},
  { 5 , ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),  ((uint16_t)0x0020) , ((uint32_t)0x00000040), Bit_RESET},
  { 6 , ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),  ((uint16_t)0x0040) , ((uint32_t)0x00000040), Bit_RESET},
  { 7 , ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),  ((uint16_t)0x0080) , ((uint32_t)0x00000040), Bit_RESET}
};
...
void st7066_init(void)
{
  ...
  dev_write_command (0x20); 
  dev_write_command (0x08); 
  dev_write_command (0x01); 
  dev_write_command (0x06); 
  dev_write_command(0x0C);
  dev_write_command(0x01);
...
void st7066_setmode(int mode)
{
	...
	case  1:
	  ...
	  break;
	case  2:
      dev_write_command(0x0E);
	  break;
	case  3:
	  dev_write_command(0x0F);
	  break;
	}
}
...
static void dev_GPIO_init(void)
{
  ...
  for(pin=0; pin<(sizeof(oDev)/sizeof(lcd_dev)); pin++) {
...
static void dev_write_command(uint8_t data )
{
  ...
  if((data&0x80)!=0) PIN_SET(7); else PIN_RESET(7);
  if((data&0x40)!=0) PIN_SET(6); else PIN_RESET(6);
  if((data&0x20)!=0) PIN_SET(5); else PIN_RESET(5);
  if((data&0x10)!=0) PIN_SET(4); else PIN_RESET(4);
  dev_lcd_strob();
  if((data&0x08)!=0) PIN_SET(7); else PIN_RESET(7);
  if((data&0x04)!=0) PIN_SET(6); else PIN_RESET(6);
  if((data&0x02)!=0) PIN_SET(5); else PIN_RESET(5);
  if((data&0x01)!=0) PIN_SET(4); else PIN_RESET(4);
  dev_lcd_strob();
}
