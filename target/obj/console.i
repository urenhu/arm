...
static int gpio_entry(void)
{
   MenuStart("gpio",gpio,0,0);
   return(0);
}

static int fram_entry(void)
{
   MenuStart("fram", framo, 0, 0);
   return(0);
}
