...
#line 1 "..\\STM32F10x_StdPeriph\\inc\\stm32f10x_spi.h"
...
#line 33 "..\\STM32F10x_StdPeriph\\inc\\stm32f10x_spi.h"
...
#line 136 "..\\STM32F10x_StdPeriph\\inc\\stm32f10x_spi.h"
...
#line 220 "..\\STM32F10x_StdPeriph\\inc\\stm32f10x_spi.h"
...
#line 248 "..\\STM32F10x_StdPeriph\\inc\\stm32f10x_spi.h"
...
#line 266 "..\\STM32F10x_StdPeriph\\inc\\stm32f10x_spi.h"
...
#line 282 "..\\STM32F10x_StdPeriph\\inc\\stm32f10x_spi.h"
...
#line 312 "..\\STM32F10x_StdPeriph\\inc\\stm32f10x_spi.h"
...
#line 396 "..\\STM32F10x_StdPeriph\\inc\\stm32f10x_spi.h"
...
#line 417 "..\\STM32F10x_StdPeriph\\inc\\stm32f10x_spi.h"
...
void usrspi2_init ( int threewire, int lsbfirst, int spimode )
{
    ...
    SPI_InitTypeDef     SPI_InitStructure;
		...
		if ( threewire ) {
			GPIO_InitStructure.GPIO_Pin   = ((uint16_t)0x2000) | ((uint16_t)0x8000);
	  } else {
    ...
    if ( threewire ) {
        SPI_InitStructure.SPI_Direction = ((uint16_t)0xC000); 
    } else {
    ...
    SPI_InitStructure.SPI_BaudRatePrescaler = ((uint16_t)0x0018);    
    if ( lsbfirst ) {
        SPI_InitStructure.SPI_FirstBit = ((uint16_t)0x0080);
    } else {
...
void usrspi2_SendByte3Wire(u8 data)
{
    ...
    SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), data); 

    retry=0;
    
    while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), ((uint16_t)0x0080)) == SET) { 
        retry++;
...
u8   usrspi2_ReadByte3Wire()
{
    ...
    SPI_BiDirectionalLineConfig (((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), ((uint16_t)0xBFFF));  
    SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), 0x00); 
    retry = 0;
    while (!(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800))->SR & ((uint16_t)0x0001))) {  
        retry++;
        
				
    }
    SPI_BiDirectionalLineConfig(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), ((uint16_t)0x4000));

    result = SPI_I2S_ReceiveData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)));
