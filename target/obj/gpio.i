...
static int read_gpio(const char *portStr)
{
  int ret = 0;
	...
	voltageR = usradc_getav(((uint8_t)0x01), 10 );
...
static int write_gpio(const char *portStr)
{
  int ret = 0;
	...
	TIM_SetCompare2(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), (u16)led0pwmval);		   
...
static int get_gpio (const char *portStr,const char *pinStr)
{
  ...
  case 'a':
  case 'A':
	  value = GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),1<<pin);
	  break; 
  case 'b':
  case 'B':
	  value = GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),1<<pin);
	  break; 
  case 'c':
  case 'C':
	  value = GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),1<<pin);
	  break; 
  default:
    break;
  }	
...
static int set_gpio (const char *portStr,const char *pinStr)
{
  ...
  case 'a':
  case 'A':
		GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),1<<pin);
	  break; 
  case 'b':
  case 'B':
		GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),1<<pin);
	  break; 
  case 'c':
  case 'C':
		GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),1<<pin);
	  break; 
  default:
    break;
  }	
...
static int reset_gpio (const char *portStr,const char *pinStr)
{
  ...
  case 'a':
  case 'A':
		GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),1<<pin);
	  break; 
  case 'b':
  case 'B':
		GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),1<<pin);
	  break; 
  case 'c':
  case 'C':
		GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),1<<pin);
	  break; 
  default:
    break;
  }	
