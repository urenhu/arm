...
#line 5 "..\\usr_lib\\usr_tsensor.c"

void usrtadc_init(void)
{
	ADC_InitTypeDef ADC_InitStructure; 
	RCC_APB2PeriphClockCmd(((uint32_t)0x00000004) |((uint32_t)0x00000200)	, ENABLE );	  
...
u16 usrtadc_getadc (u8 ch)   
{
 	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ch, 1, ((uint8_t)0x07) );	
	...
	return ADC_GetConversionValue(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)));	
}
...
u16 usrtadc_gettm (int filter_len )
{
	...
	for(t=0; t<filter_len; t++){
		temp_val += usrtadc_getadc (((uint8_t)0x10));	 
		delay_ms(5);
	}
