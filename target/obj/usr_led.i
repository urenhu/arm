...
static ledMapper oLedAry[2] = {
 {0, 'A', ((uint16_t)0x0040), 0 },
 {1, 'A', ((uint16_t)0x0080), 0 }
};
  ...
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;		 
    ...
    switch ( oLedAry[k].port ) {
      ...
      if (oLedAry[k].def_val){ 		
        GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),oLedAry[k].pin);						 
		  } else {
		    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),oLedAry[k].pin);						 
		  }
			break;
...
void usrled_on (int idx)
{
    ...
    switch ( oLedAry[idx].port ) {
		case 'A':
	    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),oLedAry[idx].pin);
      break;
...
void usrled_off (int idx)
{
    ...
    switch ( oLedAry[idx].port ) {
		case 'A':
	    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),oLedAry[idx].pin);
      break;
