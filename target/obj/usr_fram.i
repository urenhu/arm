...
{   
    ...
    RCC_APB2PeriphClockCmd( ((uint32_t)0x00000008)|((uint32_t)0x00000020)|((uint32_t)0x00000100), ENABLE );
    ...
    usrspi2_init(0,0,3);        
    usrspi2_setspeed(((uint16_t)0x0000));
}  
...
{  
    ...
    *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(12<<2)))) = 0;                           
    usrspi2_WriteReadAByte(0x05);
    byte=usrspi2_WriteReadAByte(0Xff); 
