...
#line 13 "..\\sensor\\adns5020.c"


#line 23 "..\\sensor\\adns5020.c"
...
static void write(u8 address, u8 data)
{
  	...
  	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(0<<2)))) = 0; 
	  opcode = address | 0x80;
...
void adns5020_pixels(u8* buffer ) 
{
    ...
    u8   data    = 0 ;
	  u8   opcode  = 0;
		...
		write(0x0b, 0x00);   
  	for(pixel_count = 0; pixel_count < 225;  pixel_count++ ) {
        buffer[pixel_count] = read(0x0b);
    }
}
...
{   
    ...
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0001) | ((uint16_t)0x0002) );
